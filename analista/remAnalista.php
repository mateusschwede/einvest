<?php
    ...
    if(!empty($_POST['remAnalista'])) {
        $r = $db->prepare("DELETE FROM analista WHERE nome=? AND senha=?");
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h1>Remover analista <?=$_SESSION['nome']?>?</h1>
            <form action="remAnalista.php" method="post">
                <input type="hidden" name="remAnalista" value=1>
